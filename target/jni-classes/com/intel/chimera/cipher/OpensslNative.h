...
#include <jni.h>
/* Header for class com_intel_chimera_cipher_OpensslNative */

#ifndef _Included_com_intel_chimera_cipher_OpensslNative
#define _Included_com_intel_chimera_cipher_OpensslNative
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_intel_chimera_cipher_OpensslNative
 * Method:    initIDs
 * Signature: ()V
 */
